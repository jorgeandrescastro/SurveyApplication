...
$(document).ready(function() {
  ...
  if($("input:radio[name=question_20]").length ) {
  ...
  if($("input:radio[name=question_23]").length ) {
  ...
  if($("input:radio[name=question_26]").length ) {
  ...
  if($("input:radio[name=question_41]").length ) {
  ...
  if($("input:radio[name=question_44]").length ) {
